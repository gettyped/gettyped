...
[[https://travis-ci.org/gettyped/gettyped][https://travis-ci.org/gettyped/gettyped.png]]
...
Latest Scala source is available in [[//gettyped.tar.gz][tar]] and [[//gettyped.zip][zip]] archives.
